...
module.exports = class UsersController {
    ...
    static async Login(req, res) {
        try {
            ...
            //     throw new Error(
            //         "Internal server error, cannot send verification code"
            //     );
            // }
    ...
    static async EditPersonalData(req, res) {
        try {
            ...
            let user = await req.db.users.update(data, {
                where: {
                    user_id: req.user.id,
                },
                raw: true,
    ...
    static async AvatarPatchController(req, res) {
        try {
            ...
            if (!avatar) throw new Error("Avatar is not found");
